...
public class FenetreTop4 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FenetreTop4 window = new FenetreTop4();
	...
	private void initialize() {
		...
		sl_panelTime.putConstraint(SpringLayout.NORTH, listNextPassages, 115, SpringLayout.NORTH, labelElapsedTimeValue);
		...
		sl_panelTime.putConstraint(SpringLayout.EAST, listNextPassages, -100, SpringLayout.EAST, panelTime);
