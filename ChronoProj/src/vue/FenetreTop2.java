...
public class FenetreTop2 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FenetreTop2 window = new FenetreTop2();
	...
	private void initialize() {
		...
		frmTop.setSize(screenSize.width * 4 / 5, screenSize.height * 4 / 5);
		...
		panelTime.setPreferredSize(new Dimension(frmTop.getWidth() / 3, frmTop.getHeight() / 2 - menuBarEvent.getHeight()));
		...
		sl_panelTime.putConstraint(SpringLayout.SOUTH, listNextPassages, -29, SpringLayout.SOUTH, panelTime);
		...
		panelMainCar.setPreferredSize(new Dimension(frmTop.getWidth() / 3 + 80, frmTop.getHeight() / 2 - menuBarEvent.getHeight()));
		...
		panelInformation.setPreferredSize(new Dimension(frmTop.getWidth() / 3 - 80, frmTop.getHeight() / 2 - menuBarEvent.getHeight()));
