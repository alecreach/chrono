...
public class FenetreNewTop extends JFrame implements ActionListener {
	...
	//Variable int qui indique le type de fin, 0 = fin à l'heure, 1 = fin hybride, 2 = fin au nombre de tours
	...
	// Met à jour les différents textes qu'il faut traduire lorsque l'on change
	// de langue
